...
\hline
\textcolor{red}{TEST\_USERS} & \textcolor{red}{A group of users chosen by the development team for their unique background and help round of an age range from 12 to 25. These users will also have ot self identity as familiar with the orginal game.} & \textcolor{red}{N/A}\\
\hline
\textcolor{red}{\INITIAL\_NAV\_TIME} & \textcolor{red}{1 minute and 30 seconds.} & \textcolor{red}{N/A}\\
\hline
\textcolor{red}{INITIAL\_UNDERSTANDING\_TIME} & \textcolor{red}{30 seconds} & \textcolor{red}{N/A}\\
\hline
\textcolor{red}{MOVEMENT\_TIME} & \textcolor{red}{10 seconds} & \textcolor{red}{N/A}\\
\hline
\end{tabular}
\end{table}
